...
/**
 * We have seen here(copyDirectory001) how to copy directories recursively.
 * To take advantage of multiple cores we can create independent child directories in different threads. Following example shows how to do that.
 */
