...
public class ThenComposeExample2 {
    ...
    public static void main(String[] args) {
        ...
        CompletableFuture<Long> composedCompletableFuture = firstCompletableFuture.thenComposeAsync(ThenComposeExample2::getSecondCompletableFuture);

        CompletableFuture<Double> secondComposedCompletableFuture = composedCompletableFuture.thenComposeAsync(ThenComposeExample2::getThirdCompletableFuture);
